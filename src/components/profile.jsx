    ...
    return (
        <>
            ...
            <div className="flex justify-center gap-4 m-4">
                <a href="mailto:ignodi@gmail.com" target="_blank" rel="noopener noreferrer">
                    <MdOutlineEmail size={40} />
                </a>
                <a href="https://www.linkedin.com/in/ignatius-odi/" target="_blank" rel="noopener noreferrer">
                    <FaLinkedin size={40} />
                </a>
                <a href="https://github.com/IgnatiusOdi" target="_blank" rel="noopener noreferrer">
                    <FaGithub size={40} />
                </a>
            </div>
        </>
